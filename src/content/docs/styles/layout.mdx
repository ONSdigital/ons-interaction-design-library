...
Their primary purpose is to create visual separation between adjacent content and prevent layouts from feeling crowded. Consistent gutter spacing helps establish visual rhythm and improves the readability of content, navigation elements and data visualisations.

Gutters also help maintain clear relationships between content areas by ensuring that distinct sections remain visually separated without requiring additional styling.

### Outside margins

Outside margins provide space between the edge of the viewport and the page container.

This spacing helps prevent content from appearing cramped and creates a more comfortable reading experience across different screen sizes. It also establishes a consistent visual boundary around page content and helps maintain balance within the layout.

Outside margins reduce at smaller viewport sizes to maximise the available content area while preserving sufficient breathing room around the content.
